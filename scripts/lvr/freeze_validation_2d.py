#!/usr/bin/env python3
"""Freeze the amended validation-grid candidate universe before fresh held-out simulation."""
...
inputs = [
    ...
    ROOT / "scripts/lvr/select_2d.py",
    ROOT / "scripts/lvr/diagnostics_analyze.py",
    ROOT / "scripts/lvr/validate_select_2d.py",
    ROOT / "src/bin/lvr_train_2d.rs",
...
plan = {
    "step": "validation-grid amended immutable fresh-validation plan",
