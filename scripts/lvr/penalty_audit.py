#!/usr/bin/env python3
"""Post-hoc exact-penalty audit using only frozen validation-grid artifacts.
...
report = f"""# validation-grid Exact-Penalty Audit

## Status and scope

This is a post-hoc, theory-guided re-analysis of the frozen validation-grid evaluation
