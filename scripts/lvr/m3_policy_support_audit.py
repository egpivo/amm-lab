#!/usr/bin/env python3
"""Freeze the M3 narrow-policy-family finding and design amendment."""
...
LVR = ROOT / ".local/lvr"
TRAIN = ROOT / "src/bin/lvr_m3_train.rs"
SELECT = ROOT / "scripts/lvr/m3_select.py"
POLICY = ROOT / "src/campbell/fee_policy.rs"
AMENDED_TRAIN = ROOT / "src/bin/lvr_m3_train_2d.rs"
...
audit = {
    "stage": "M3 policy-support design audit",
...
lines = [
    "# M3 policy-support design audit",
    "",
    "## Decision",
    "",
