#!/usr/bin/env python3
"""Freeze one amended M3 final candidate after fresh validation selection."""
...
inputs = [
    ...
    ROOT / "scripts/lvr/m3_final_analyze_2d.py",
    ROOT / "src/bin/lvr_m3_validate_2d.rs",
    ROOT / "src/bin/lvr_m3_final_2d.rs",
...
plan = {
    "step": "M3 amended immutable fresh-final plan",
