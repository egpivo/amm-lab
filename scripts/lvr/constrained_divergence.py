#!/usr/bin/env python3
"""Constrained loss-vs-surplus selection divergence on frozen validation-grid training means."""
...
report = f"""# validation-grid Constrained-Ranking Divergence

## Scope

This is a post-hoc evaluation-layer calculation on frozen validation-grid training means.
