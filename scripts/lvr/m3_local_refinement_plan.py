...
inputs = [
    Path("Cargo.toml"),
    Path("Cargo.lock"),
    Path("src/bin/lvr_m3_refine.rs"),
    Path("src/campbell/fee_policy.rs"),
    Path("src/campbell/gbm.rs"),
    Path("src/campbell/simulation.rs"),
    Path("src/campbell/summary.rs"),
    Path("scripts/lvr/m3_local_refinement_prepare.py"),
    Path("scripts/lvr/m3_local_refinement_plan.py"),
    Path("scripts/lvr/m3_local_refinement_analyze.py"),
