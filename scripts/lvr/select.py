#!/usr/bin/env python3
"""validation-grid Step C post-processing: selection on the training block.

Reads m3_training_rows_shard*.csv.gz (per-seed rows from lvr_train),
...
selection_path.write_bytes(json_bytes({
    "step": "training-selection selection (training block)",
...
plan = {
    "step": "validation immutable validation plan",
