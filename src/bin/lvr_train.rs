//! validation-grid Step C: training-block dial-grid evaluation.
//!
...
//!   lvr_train --n-seeds 100 --seed-start 20000 [--shard 0 --of 4]
...
fn config_for(cell: &Cell) -> SimConfig {
    ...
    SimConfig {
        name: "m3train".into(),
        description: "validation-grid step C training dial grid".into(),
        amm_fee: cell.fee,
        cex_fee: 0.0010,
