//! validation-grid Step E: untouched-final verification of one validation-selected pair.
...
fn config_for(cell: &Cell) -> SimConfig {
    ...
    SimConfig {
        name: "m3final".into(),
        description: "validation-grid step E untouched-final verification".into(),
        amm_fee: cell.fee,
        cex_fee: 0.0010,
