//! validation-grid disclosed design amendment: genuine (f0, alpha) gap-family grid.
//!
...
fn config_for(cell: &Cell) -> SimConfig {
    ...
    SimConfig {
        name: "m3train2d".into(),
        description: "validation-grid amended two-dimensional gap grid, training only".into(),
        amm_fee: cell.fee,
        cex_fee: 0.0010,
