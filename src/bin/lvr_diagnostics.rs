//! Training-only diagnostics for policies selected from the amended validation-grid grid.
...
fn config_for(cell: &Cell) -> SimConfig {
    ...
    SimConfig {
        ...
        description: "validation-grid amended selected-policy training diagnostics".into(),
        amm_fee: cell.fee,
        cex_fee: 0.0010,
